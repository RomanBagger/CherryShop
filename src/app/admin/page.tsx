...
import { Package, ShoppingCart, Users, Settings, BarChart3, Plus, Edit, Trash2, Upload, Save, X } from 'lucide-react';
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">MumiShop - Админ панель</h1>
